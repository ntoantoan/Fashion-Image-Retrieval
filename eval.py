...
#     print(image_model)
#     swin_model = torch.load(image_model, map_location=device)
...
#     cap_model = torch.load(cap_model, map_location=device)
...
#             candidate_ft = swin_model(candidate_images)
#             captions = captions.to(device)
#             caption_ft = cap_model(captions, lengths)
...
#     parser.add_argument('--model_folder', type=str, default='models/dress-20240923-152341/',
